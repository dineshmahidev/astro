    ...
    const fetchHomeData = async () => {
        try {
            ...
            setData({
                ...
                rasi: (user as any)?.rasi || 'Mesha / மேஷம்',
                nakshatra: (user as any)?.nakshatra || 'Aswini / அஸ்வினி'
            });
            ...
            >
                ...
                <View>
                    ...
                    <View>
                        ...
                        >
                            <Animated.View entering={FadeInDown.delay(300).duration(1000)} style={[styles.pathCardWrapper, { borderColor: Branding.gold, borderWidth: 2 }]}>
                ...
                <Animated.View entering={FadeInDown.delay(200).duration(500)} style={styles.impactCard}>
                    ...
                    >
                        ...
                        <Text style={styles.palanText}>
                            {dailyImpacts && dailyImpacts[0]?.palan || '"இன்றைய நாள் ஆன்மீக வளர்ச்சிக்கும் அமைதியான உறவுகளுக்கும் ஏற்றது. உங்கள் உள்மனதைக் கவனியுங்கள்."'}
                        </Text>
                        ...
                        <View style={styles.tableGrid}>
                            <View style={styles.tableRow}>
                                <View style={[styles.tableCell, { borderRightWidth: 1, borderColor: 'rgba(255,255,255,0.05)' }]}>
                                    ...
                                    <Text style={styles.cellText}>தியானம் செய்யவும் {"\n"}நன்றி உணர்வுடன் இருங்கள்</Text>
                                </View>
                                <View style={styles.tableCell}>
                                    ...
                                    <Text style={styles.cellText}>வாக்குவாதம் தவிர்க்கவும் {"\n"}பெரிய முதலீடு வேண்டாம்</Text>
                                </View>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    avatarInitial: { color: Branding.black, fontSize: 18, fontWeight: 'bold' },
    ...
    heroBtnText: { color: '#000', fontSize: 14, fontWeight: 'bold' },
